...
@section('title-right')
    {!! Html::link(
        admin_route('ecommerce.filters.create'),
                    ...
                    <table class="table table-striped b-t b-light">
                        ...
                        @forelse($items as $item)
                            <tr>
                                ...
                                <td>
                                    <a class = 'btn btn-sm btn-default' href="{{ admin_route('ecommerce.filters.edit', [$item->id]) }}">
                                        {{ trans('admin::default.actions.edit') }}
                                    </a>
                                    <a class = 'btn btn-sm btn-danger destroy-confirm' href="{{ admin_route('ecommerce.filters.destroy', [$item->id]) }}">
