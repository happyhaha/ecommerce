                ...
                <div class="table-responsive">
                    <table class="table table-striped b-t b-light">
                        ...
                        <tr>
                            ...
                            <th>{{ trans('ecommerce::default.'.$codename.'.fields.id') }}</th>
                            <th>{{ trans('ecommerce::default.'.$codename.'.fields.title') }}</th>
                        ...
                        @forelse($items as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class = 'btn btn-sm btn-danger destroy-confirm' href="{{ admin_route('ecommerce.'.$codename.'.destroy', [$item->id]) }}">
                        ...
                        @empty
                            <tr>
                                <td colspan="5">{{ trans('ecommerce::default.'.$codename.'.empty') }}</td>
                            </tr>
                        @endforelse
                        </tbody>
                    </table>
